        ...
        <div className="min-h-30 bg-[#1a1a2e] text-white p-5 relative mt-2"
          ...
          <div className='flex items-center justify-center text-center'>
            <div className="flex flex-col items-center gap-4">
              ...
              <h1 className="lg:text-2xl sm:text-xm tracking-wider text-white mb-2.5" style={{ textShadow: '4px 4px 0 rgba(0,0,0,1)' }}>
          ...
          15% 100%, 15% 95%, 10% 95%, 10% 90%, 5% 90%, 5% 85%, 0% 85%
              ...
              <div className="relative flex items-center justify-center gap-2 text-2xl italic font-bold text-center text-white group">
                <div className="p-0.5 w-full bg-white" />
                <span className="text-center text-md whitespace-nowrap">Direct contact</span>
                <div className="p-0.5 w-full bg-white" />
              </div>
          ...
          15% 100%, 15% 95%, 10% 95%, 10% 90%, 5% 90%, 5% 85%, 0% 85%
              ...
              <div className="relative flex items-center justify-center gap-2 text-2xl italic font-bold text-center text-white group">
                <div className="p-0.5 w-full bg-white" />
                <span className="text-center text-md whitespace-nowrap">Social Links</span>
                <div className="p-0.5 w-full bg-white" />
              </div>
