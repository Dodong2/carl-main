import{j as a,r as i}from"./index-C9LZwH8w.js";const u=({children:s,title:e,variant:n="default",size:t="md",className:l=""})=>{const o={sm:"max-w-sm p-2 text-xs",md:"max-w-md p-4 text-sm",lg:"max-w-lg p-5 text-base",xl:"max-w-xl p-8 text-lg"},r={default:`
