import{j as e}from"./index-SXw1HhQz.js";const t=({children:r,size:s="md",variant:a="default",className:n=""})=>{const x={sm:"w-32 h-32 p-3",md:"w-48 h-48 p-4",lg:"w-64 h-64 p-6",xl:"w-80 h-80 p-8"},i={default:`
