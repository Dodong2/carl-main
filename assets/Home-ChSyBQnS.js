import{j as e,r as o}from"./index-Dta9UGzq.js";const g=({children:a,title:s,variant:n="default",size:t="md",className:l=""})=>{const i={sm:"max-w-sm p-2 text-xs",md:"max-w-md p-4 text-sm",lg:"max-w-lg p-5 text-base",xl:"max-w-xl p-8 text-lg"},r={default:`
