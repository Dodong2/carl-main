import{j as a,r as l}from"./index-dWljdvXg.js";const u=({children:r,title:e,variant:s="default",size:n="md",className:i=""})=>{const o={sm:"max-w-sm p-2 text-xs",md:"max-w-md p-4 text-sm",lg:"max-w-lg p-5 text-base",xl:"max-w-xl p-8 text-lg"},t={default:`
