import{r as d,j as e}from"./index-C4Ctjg9d.js";import{u as g,R as b,a as f}from"./RetroModal-CA5DD_NT.js";import{R as _}from"./RetroButton-C3l_CcQH.js";const y="/carl-main/assets/Me-GSQfVFah.png",j="/carl-main/assets/Carl_Stephen_Arocha_Resume-Bje5DMiH.pdf",u=[{id:"1",image:y,resume:j,dialogue:["Greetings! My name is Carl Stephen Arocha. I'm currently a fourth-year BSIT student and a vibe coder full stack developer.","As a web developer, I'm still at the beginner level, but I'm constantly learning and building projects to level up my skills.","I'm eager to expand my portfolio and open to collaborating on projects that match my skill set. Check out my skills and experience below!","Please click continue to view my resume and see what this warrior can bring to the table!","Thank you for taking the time to learn more about me. Let's build something awesome together!"],buttonLabels:[{label:"Resume/Stats"},{label:"continue"}]}],v=({src:r,alt:i,size:a="md",variant:n="default",badge:t,className:c=""})=>{const[l,o]=d.useState(!1),s={sm:"w-24 h-24",md:"w-40 h-40",lg:"w-56 h-56",xl:"w-72 h-72"},x={default:`
    ...
    15% 100%, 15% 95%, 10% 95%, 10% 90%, 5% 90%, 5% 85%, 0% 85%
        ...
        `,style:{clipPath:m},onMouseEnter:()=>o(!0),onMouseLeave:()=>o(!1),children:[e.jsxs("svg",{className:"absolute inset-0 w-full h-full pointer-events-none",style:{zIndex:2},children:[e.jsx("defs",{children:e.jsx("clipPath",{id:`pixelCircle-${i}`,children:e.jsx("polygon",{points:`\r
              ...
              `,vectorEffect:"non-scaling-stroke",transform:"scale(0.01)",style:{transformOrigin:"center"}})})}),e.jsx("rect",{x:"0",y:"0",width:"100%",height:"100%",fill:"none",stroke:p[n],strokeWidth:"4",clipPath:`url(#pixelCircle-${i})`})]}),e.jsx("img",{src:r,alt:i,loading:"lazy",decoding:"async",className:`
          ...
          `,style:{backgroundImage:`
            ...
            `}}),l&&n==="neon"&&e.jsx("div",{className:"absolute inset-0 bg-cyan-400/10 animate-pulse"}),t&&e.jsx("div",{className:"absolute top-2 right-8 bg-red-500 text-white text-[8px] px-2 py-1 font-['Press_Start_2P'] shadow-lg z-10",style:{clipPath:"polygon(10% 0%, 90% 0%, 100% 10%, 100% 90%, 90% 100%, 10% 100%, 0% 90%, 0% 10%)"},children:t}),l&&n==="glitch"&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 bg-cyan-500/20 mix-blend-screen animate-pulse",style:{animationDuration:"0.1s"}}),e.jsx("div",{className:"absolute inset-0 bg-magenta-500/20 mix-blend-screen animate-pulse",style:{animationDuration:"0.15s",animationDelay:"0.05s"}})]})]})]})},w=()=>{const[r,i]=d.useState(!1),[a,n]=d.useState(0),[t,c]=d.useState(""),o=u[0].dialogue,s=o[a]??"";d.useEffect(()=>{if(s&&t.length<s.length){const h=setTimeout(()=>{c(s.slice(0,t.length+1))},30);return()=>clearTimeout(h)}},[t,s]);const x=()=>{a<o.length-1?(n(a+1),c("")):i(!0)},p=t.length<s.length,m=!p&&t.length>0;return{showResume:r,displayedText:t,isTyping:p,showContinue:m,handleContinue:x,isLastDialogue:a===o.length-1}},k=()=>{const{showResume:r,displayedText:i,showContinue:a,handleContinue:n}=w(),{read:t,openModal:c,closeModal:l,animate:o}=g();return e.jsx("section",{id:"home",className:"min-h-screen",children:u.map(s=>e.jsxs("div",{className:"flex flex-col items-center justify-center p-5 mt-40 lg:gap-4 lg:flex-row",children:[e.jsxs("div",{className:"grid md:gap-0 sm:gap-0 lg:gap-1",children:[e.jsx(v,{size:"lg",variant:"glitch",src:s.image,alt:"Ryu",badge:"WARRIOR"}),r&&e.jsx(_,{color:"red",onClick:c,children:s.buttonLabels[0].label})]}),e.jsx("div",{children:e.jsxs(b,{size:"lg",title:"Carl",children:[e.jsxs("div",{className:"text-xs leading-relaxed sm:text-sm md:text-base",children:[i,!a&&e.jsx("span",{className:"animate-pulse",children:"▌"})]}),e.jsx("div",{className:"flex justify-end mt-1",children:a&&!r&&e.jsxs("button",{className:"relative animate-pulse",onClick:n,children:[e.jsx("span",{className:"absolute -top-1/14 -left-5",children:"▶"}),e.jsx("span",{className:"text-center",children:s.buttonLabels[1].label})]})})]})}),t&&e.jsx(f,{onClose:l,animate:o,children:e.jsx("div",{className:"w-full h-[80vh] overflow-auto",children:e.jsx("embed",{src:s.resume,type:"application/pdf",width:"100%",height:"100%",className:"min-h-[600px]"})})})]},s.id))})};export{k as default};
